...
public class MADLibUnitTest extends InstrumentationTestCase   {
    ...
    public static String MainURL = "https://pastebin.com/raw/wgkJgazE";
    ...
    public void testCallMultiRequests() throws Throwable {
        ...
        final MDownloadDataType mDataTypeJson1 = new MDownloadDataTypeImage(MainURL, new InterfaceForDataType("JSON-1"));
        final MDownloadDataType mDataTypeJson2 = new MDownloadDataTypeImage(MainURL, new InterfaceForDataType("JSON-2"));
        MDownloadDataType mDataTypeJson3 = new MDownloadDataTypeImage(MainURL, new InterfaceForDataType("JSON-3"));
